...
[**bulkDeleteAnalyses**](AnalysesCoreApi.md#bulkDeleteAnalyses) | **PATCH** /v2/analyses/delete | Bulk Delete Analyses
...
import type { AnalysesCoreApiBulkAddAnalysisTagsRequest } from '@revengai/sdk';

const configuration = createConfiguration();
const apiInstance = new AnalysesCoreApi(configuration);

const request: AnalysesCoreApiBulkAddAnalysisTagsRequest = {
...
```typescript
import { createConfiguration, AnalysesCoreApi } from '@revengai/sdk';
import type { AnalysesCoreApiBulkDeleteAnalysesRequest } from '@revengai/sdk';

const configuration = createConfiguration();
const apiInstance = new AnalysesCoreApi(configuration);

const request: AnalysesCoreApiBulkDeleteAnalysesRequest = {
