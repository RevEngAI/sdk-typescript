...
export class ImportedFunctionDetailOutputBody {
    /**
    * Internal functions that call this import, resolved via its PLT/stub addresses.
    */
    'callers': Array<ImportedFunctionCallerEntry> | null;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "callers",
            "baseName": "callers",
            "type": "Array<ImportedFunctionCallerEntry>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ImportedFunctionDetailOutputBody.attributeTypeMap;
    }
