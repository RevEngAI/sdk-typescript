...
export class EventRUNSTARTED {
    'data': SseEventRunStartedData;
    /**
    * The event name.
    */
    'event': EventRUNSTARTEDEventEnum;
    /**
    * The event ID.
    */
    'id'?: number;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "SseEventRunStartedData",
            "format": ""
        },
        {
            "name": "event",
            "baseName": "event",
            "type": "EventRUNSTARTEDEventEnum",
            "format": ""
        },
        {
            "name": "id",
    ...
    static getAttributeTypeMap() {
        return EventRUNSTARTED.attributeTypeMap;
    }
