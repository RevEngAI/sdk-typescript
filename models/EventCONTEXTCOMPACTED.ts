...
export class EventCONTEXTCOMPACTED {
    'data': SseEventContextCompactedData;
    /**
    * The event name.
    */
    'event': EventCONTEXTCOMPACTEDEventEnum;
    /**
    * The event ID.
    */
    'id'?: number;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "SseEventContextCompactedData",
            "format": ""
        },
        {
            "name": "event",
            "baseName": "event",
            "type": "EventCONTEXTCOMPACTEDEventEnum",
            "format": ""
        },
        {
            "name": "id",
    ...
    static getAttributeTypeMap() {
        return EventCONTEXTCOMPACTED.attributeTypeMap;
    }
