 ...
 * no description
 */
export class AnalysesDynamicExecutionApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getNetworkOverview(analysisId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/network-overview'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)));
    ...
    public async getProcessDump(analysisId: number, dumpName: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'analysisId' is not null or undefined
        if (analysisId === null || analysisId === undefined) {
            throw new RequiredError("AnalysesDynamicExecutionApi", "getProcessDump", "analysisId");
        }


        // verify required parameter 'dumpName' is not null or undefined
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/process-dumps/{dump_name}'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)))
    ...
    public async getProcessDumps(analysisId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/process-dumps'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)));
    ...
    public async getProcessRegistry(analysisId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/process-registry'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)));
    ...
    public async getProcessTree(analysisId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/process-tree'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)));
    ...
    public async getTtps(analysisId: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/analyses/{analysis_id}/dynamic-execution/ttps'
            .replace('{' + 'analysis_id' + '}', encodeURIComponent(String(analysisId)));
...
export class AnalysesDynamicExecutionApiResponseProcessor {
     ...
     */
     public async getDynamicExecutionStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseDynamicExecutionStatus >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseDynamicExecutionStatus = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseDynamicExecutionStatus", ""
            ) as BaseResponseDynamicExecutionStatus;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getNetworkOverview
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNetworkOverviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseNetworkOverviewResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseNetworkOverviewResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseNetworkOverviewResponse", ""
            ) as BaseResponseNetworkOverviewResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("422", response.httpStatusCode)) {
            const body: BaseResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getProcessDump
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProcessDumpWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getProcessDumps
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProcessDumpsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseProcessDumps >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseProcessDumps = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseProcessDumps", ""
            ) as BaseResponseProcessDumps;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("422", response.httpStatusCode)) {
            const body: BaseResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getProcessRegistry
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProcessRegistryWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseProcessRegistry >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseProcessRegistry = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseProcessRegistry", ""
            ) as BaseResponseProcessRegistry;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("422", response.httpStatusCode)) {
            const body: BaseResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getProcessTree
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProcessTreeWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseProcessTree >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseProcessTree = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseProcessTree", ""
            ) as BaseResponseProcessTree;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("422", response.httpStatusCode)) {
            const body: BaseResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getTtps
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getTtpsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BaseResponseTTPS >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BaseResponseTTPS = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BaseResponseTTPS", ""
            ) as BaseResponseTTPS;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
